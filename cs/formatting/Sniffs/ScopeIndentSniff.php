<?php
  ...
  class formatting_Sniffs_ScopeIndentSniff extends Generic_Sniffs_WhiteSpace_ScopeIndentSniff
  {
    protected $indent = 2;
        ...
        for ($i = ($scopeOpener + 1); $i < $scopeCloser; $i++) {
            ...
            if ($newline === true && $tokens[$i]['code'] !== T_WHITESPACE) {
                ...
                if (in_array($tokens[$firstToken]['code'], array(T_COMMENT, T_DOC_COMMENT)) === true) {
                    ...
                    if (in_array($tokens[$firstToken]['code'], array(T_DOC_COMMENT)) === true) {
                      $doc_comment = true;
                    }
